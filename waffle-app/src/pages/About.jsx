    ...
    <div className="about-container">
      ...
      <div className="profile-wrapper">
        <div className="profile">
          ...
          <ul>
            <li>responsible for the normalcy in naming things</li>
          <li>anime fan who asks a lot of questions</li>
          <li>University of British Columbia</li></ul>
        </div>
      </div>
      <div className="profile-wrapper">
        <div className="profile">
          ...
          <ul>
            <li>bro's entire personality is making bad puns (rlly smart tho)</li>
          <li>lightning speed at what she does - kachow</li>
          <li>University of Waterloo</li></ul>
        </div>
      </div>
      <div className="profile-wrapper">
        <div className="profile">
          ...
          <ul><li>beefy resume, devpost and github (very helpful and patient)</li>
          <li>god at backend (again, rlly smart)</li>
